      ...
      <aside style={{
        ...
        <nav>
          <ul style={{ listStyle: 'none', padding: 0 }}>
            ...
            <li style={{ marginBottom: '15px' }}>
              <Link to="/users" style={{ textDecoration: 'none', color: '#333', display: 'flex', alignItems: 'center' }}>
                <img src="/assets/images/users.svg" alt="Users" style={{ width: '20px', marginRight: '10px' }} />
                Users
              </Link>
            </li>
            <li style={{ marginBottom: '15px' }}>
